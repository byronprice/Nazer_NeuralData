...
resultNames = {'ASD_Nat','ASD_PoissNat','ASD_ResNat','ASD_PoissResNat',...
    'ASD_White','ASD_PoissWhite','ASD_Pink','ASD_PoissPink',...
    'STA_Nat','STA_PoissNat','STA_ResNat','STA_PoissResNat','STA_White',...
...
for jj=1:length(spatialFrequencies)
    ...
    for kk=1:numIter
        ...
        for ii=1:N
            ...
            temp1 = allIms(100:DIM(1)+99,100:DIM(2)+99,ii);
            temp2 = resIms(100:DIM(1)+99,100:DIM(2)+99,ii);
            temp1 = imrotate(temp1,rotate);
            temp2 = imrotate(temp2,rotate);
            temp3 = reshape(whiteData(ii,:),DIM);
            temp4 = spatialPattern(DIM,-2);
            temp4 = (temp4-mean(temp4(:)))/std(temp4(:));
            ...
            filterWhiteOutput(ii) = sum(sum(temp3.*currentFilter));
            filterPinkOutput(ii) = sum(sum(temp4.*currentFilter));
        end
        ...
        poissNat = filterNatOutput;
        poissResNat = filterResNatOutput;
        poissWhite = filterWhiteOutput;
        poissPink = filterPinkOutput;
        ...
        % restructured natural images with asd
        ...
        % restructured natural images with sta
